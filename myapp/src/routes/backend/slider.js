...
const currentModel = containService.modelControl.slider;
const subModel = containService.modelControl.category;
const mainService = currentModel.sliderService; // Service
...
const uploadFileMiddleware = utilUpload.upload("thumb", "slider");
